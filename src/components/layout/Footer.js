        ...
        <footer className="border-t border-[#1a2235] bg-[#06080d]">
            ...
            >
                ...
                <div className="flex flex-col gap-3 flex-1 items-center lg:items-start">
                    ...
                    <Link
                        href="/contacto"
                        className="flex items-center justify-center gap-2 border border-gray-600 px-3 h-[36px] rounded-md text-sm text-gray-300 hover:text-white hover:border-blue-500 hover:bg-[#0f1623] transition-all duration-200 w-[140px] mt-1"
                    >
                        {t.footer.cta}
                ...
                <div className="flex flex-col gap-4 lg:w-[260px] shrink-0 items-center">
                    ...
                    <div className="flex items-center gap-3">
                        <a
                            ...
                            aria-label="LinkedIn"
                            className="w-10 h-10 rounded-md bg-[#0f1623] border border-[#1a2235] flex items-center justify-center text-gray-300 hover:text-white hover:border-blue-500 hover:-translate-y-0.5 transition-all duration-200"
                        >
                        ...
                        <a href="#" className="w-10 h-10 rounded-md bg-[#0f1623] border border-[#1a2235] flex items-center justify-center text-gray-300 hover:text-white hover:border-blue-500 hover:-translate-y-0.5 transition-all duration-200">
                            <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div className="flex-1 flex items-center justify-center lg:justify-end">
                    <p className="text-gray-400 text-sm text-center lg:text-right">
                        © {new Date().getFullYear()} Juan David. {t.footer.rights}
                    </p>
                </div>
