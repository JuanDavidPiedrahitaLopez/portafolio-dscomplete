            ...
            <div className="w-full h-[80px] flex items-center justify-between relative" style={{ paddingLeft: "8%", paddingRight: "8%" }}>
                ...
                <nav className="hidden lg:flex items-center gap-10 absolute left-1/2 -translate-x-1/2">
                    {links.map((link) => (
                        ...
                        >
                            <span className={`text-sm font-medium tracking-wide transition-colors duration-200 ${isHome && active === link.id ? "text-blue-400" : "text-gray-400 group-hover:text-gray-200"
                                }`}>
                                <Link
                ...
                {/* DERECHA: idioma + botón contacto (desktop) + burger (mobile) */}
